...
class Config:
    ...
    def __init__(self):
        ...
        self.input_path: str = "/mnt/data3/finLLM/agent_framework/T-Eval/data1/gen_data0911/instruct.json"
        self.output_path: str = "/mnt/data3/finLLM/agent_framework/T-Eval/data1/agent_final数据1/instruct_checked.json"
...
def generate_prompt(row) -> str:
    ...
    #instruct，plan不用筛选
    output_data1 = '"thought_start": "想法:",\n"thought_end": "\n",\n"action_start": "动作:",\n"action_end": "\n",\n"args_start": "动作参数:",\n"args_end": ""'
    output_data2 = '"thought": "想法",\n"action": "动作",\n"args": "动作输入"'
    output_data3 = '"thought": "目标",\n"action": "名称",\n"args": "参数输入"'
    output_data4 = '"thought_start": "目标:",\n"thought_end": "\n\n",\n"action_start": "名称:",\n"action_end": "\n\n",\n"args_start": "参数:",\n"args_end": ""'

    
    prompt = f"按照以下格式回答问题 <yes/no>||<explanation why yes or no>. 问题如下：给定输入: {input_data}, \n检查输入的内容是否和以下四个内容中的任何一个完全相同：{output_data1},\n{output_data2},\n{output_data3},\n{output_data4}"
    return prompt
