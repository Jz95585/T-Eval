...
class Config:
    ...
    def __init__(self):
        ...
        self.input_path: str = "/mnt/data3/finLLM/agent_framework/T-Eval/data1/gen_data_20240830_075459/instruct_format.json"
        self.output_path: str = "/mnt/data3/finLLM/agent_framework/T-Eval/data1/gen_data_20240830_075459/instruct_format.json"
...
def generate_prompt(row) -> str:
    ...
    input_data = row
    output_data1='"thought": "目标",\n"action": "名称",\n"args": "参数输入"'
    output_data2='"thought_start": "想法:",\n"thought_end": "\n",\n"action_start": "动作:",\n"action_end": "\n",\n"args_start": "动作参数:",\n"args_end": ""'
    prompt=f"请以以下格式回答我的问题：<yes/no>||<解释为什么是yes或者no>. 我的问题是：对于给定的输入:{input_data},请你检查它的template字段是否是以下内容:{output_data1}或者{output_data2}"
